...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Вычисление значений функции";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Введите значения A";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Введите значения X";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Значения функции Y=";
			// 
			// textBox1
			// 
			...
			this->Name = L"Form1";
			this->Text = L"Выполнил студент группы 23-КФ Берговин А.Р. Задание 2";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if ((textBox1->Text != "") && (textBox2->Text != ""))
	{
		...
		textBox3->Text = Convert::ToString(y);
					...
					//Вывод окна с сообщением, если не введены данные в компонентыТextBox1 и ТextBox2
					{ MessageBox::Show("Введите пожалуйста данные А и Х", "Ошибкаввода данных", MessageBoxButtons::OK, MessageBoxIcon::Exclamation); }
}
...
if (a == false)
{
	MessageBox::Show("параметр Х не является числом", "Ошибкаввода данных", MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
	//возврат фокуса текстовому полю 
	this->textBox2->Focus();
}
}
